...
class Portfolio_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_portfolio_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio V3', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_v3',
			[
				'label' => esc_html__( 'Portfolio V3', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <div class="masonry-item small-column all <?php echo esc_attr($term_slug); ?> <?php if(get_post_meta( get_the_id(), 'dimension', true) == 'extra_width_height') echo 'col-lg-6 col-md-6 col-sm-12'; elseif(get_post_meta( get_the_id(), 'dimension', true) == 'extra_width') echo 'col-lg-6 col-md-6 col-sm-12'; elseif(get_post_meta( get_the_id(), 'dimension', true) == 'extra_height') echo 'col-lg-3 col-md-6 col-sm-12'; else echo 'col-lg-3 col-md-6 col-sm-12'?>">
                        ...
                        <figure class="image-box">
                            <?php 
								...
								if($dimention == 'extra_width_height'){
									$image_size = 'wastey_570x570';
								}
								elseif($dimention == 'extra_width'){
									$image_size = 'wastey_570x270';
								}
								elseif($dimention == 'extra_height'){
									$image_size = 'wastey_270x570';
								}
								else{
									$image_size = 'wastey_270x270'; 
								}
