...
class Video_Section extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_video_section';
	}
	...
	public function get_title() {
		return esc_html__( 'Video Section', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'video_section',
			[
				'label' => esc_html__( 'Video Section', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'bg_image',
            ...
            <div class="auto-container">
                <div class="video-content">
                    <div class="pattern-layer">
                        <div class="pattern-1" style="background-image: url(<?php echo wp_get_attachment_url($settings['bg_image']['id']);?>);"></div>
