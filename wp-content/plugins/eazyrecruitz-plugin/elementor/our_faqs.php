...
class Our_Faqs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Faqs', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_faqs',
			[
				'label' => esc_html__( 'Our Faqs', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'feature_image',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Frequent Questions in', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'placeholder' => __( 'Artificial Intelligence', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
		...
		if( eazyrecruitz_set( $settings, 'query_category' ) ) $args['faqs_cat'] = eazyrecruitz_set( $settings, 'query_category' );
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure class="image-box"><img src="<?php echo wp_get_attachment_url($settings['feature_image']['id']);?>" alt="<?php esc_attr_e('Awesome Image', 'eazyrecruitz'); ?>"></figure>
                    </div>
