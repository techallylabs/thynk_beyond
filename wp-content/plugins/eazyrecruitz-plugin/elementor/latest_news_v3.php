...
class Latest_News_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_latest_news_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Latest News V3', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v3',
			[
				'label' => esc_html__( 'Latest News V3', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'View All Post', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'btn_link',
        ...
        <section class="news-section alternet-2">
            <div class="auto-container">
                <div class="sec-title">
                    ...
                    <a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="link"><i class="flaticon-right-arrow"></i><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?></a>
                </div>
