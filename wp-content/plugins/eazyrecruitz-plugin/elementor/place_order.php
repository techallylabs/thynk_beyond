...
class Place_Order extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_place_order';
	}
	...
	public function get_title() {
		return esc_html__( 'Place Order', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'place_order',
			[
				'label' => esc_html__( 'Place Order', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
            'subtitle',
	...
	protected function render() {
        ...
        <section class="placejob-section">
            <div class="auto-container">
                ...
                <?php echo do_shortcode($settings['contact_form_url5']) ;?>
            </div>
        </section>
