...
class Our_Team_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_our_team_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Team V3', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team_v3',
			[
				'label' => esc_html__( 'Our Team V3', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'subtitle',
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            <figure class="image-box">
                                <?php the_post_thumbnail('eazyrecruitz_370x274'); ?>
