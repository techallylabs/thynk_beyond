 ...
 * @since 1.0.0
 */
class Experience_Block extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_experience_block';
	}
	...
	public function get_title() {
		return esc_html__( 'Experience Block', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'experience_block',
			[
				'label' => esc_html__( 'Experience Block', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'subtitle',
