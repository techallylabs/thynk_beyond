 ...
 * @since 1.0.0
 */
class Our_Advantages extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_our_advantages';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Advantages', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_advantages',
			[
				'label' => esc_html__( 'Our Advantages', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
            'style_two',
			[
				'label'   => esc_html__( 'Choose Different Style', 'strike' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'one',
				'options' => array(
					'one' => esc_html__( 'Choose Style One', 'strike' ),
					'two'  => esc_html__( 'Choose Style Two', 'strike' ),
				),
			]
		);
