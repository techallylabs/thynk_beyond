 ...
 * @since 1.0.0
 */
class Project_Block_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_project_block_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Projects block V2', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'project_block_v2',
			[
				'label' => esc_html__( 'Projects Block V2', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'query_number',
