...
class Our_Team_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_our_team_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Team V2', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team_v2',
			[
				'label' => esc_html__( 'Our Team V2', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	protected function render() {
        ...
        <!-- team-style-two -->
        <section class="team-style-two <?php if($settings['style_two'] == 'two') echo 'bg-color-2 centred'; else echo ''; ?>">
