...
class Portfolio_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_portfolio_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio V2', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_v2',
			[
				'label' => esc_html__( 'Portfolio V2', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'number',
                ...
                <div class="project-block-two">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            ...
                            <div class="link"><a href="<?php echo esc_url($post_thumbnail_url);?>" class="lightbox-image" data-fancybox="gallery">+</a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="auto-container">
                    <div class="sortable-masonry">
                        ...
                        <div class="pagination-wrapper centred">
                            <?php eazyrecruitz_the_pagination2(array('total'=>$query->max_num_pages, 'next_text' => '<i class="flaticon-right-arrow-2"></i> ', 'prev_text' => '<i class="flaticon-arrowhead-thin-outline-to-the-left"></i>')); ?>
                        </div>
                    </div>
                </div>
            </section>
