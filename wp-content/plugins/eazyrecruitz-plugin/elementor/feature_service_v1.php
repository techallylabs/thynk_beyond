...
class Feature_Service_V1 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_feature_service_v1';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature Service V1', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature_service_v1',
			[
				'label' => esc_html__( 'Feature Service V1', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
              'features', 
			  	[
            		...
            		'default' => 
						[
                			['title' => esc_html__('Sourcing the Best', 'eazyrecruitz')],
                			['title' => esc_html__('Volume Hiring', 'eazyrecruitz')],
							['title' => esc_html__('Partners in Team Building', 'eazyrecruitz')],
            			],
            		'fields' => 
						[
                			[
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                                    <div class="single-item wow fadeInRight animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div class="inner">
                                            ...
                                            <h3><span><?php $count = sprintf('%02d', $count); echo $count; ?></span><a href="<?php echo esc_url($item['ext_link']['url']) ;?>"><?php echo wp_kses($item['title'], $allowed_tags) ;?><i class="flaticon-right-arrow"></i></a></h3>
