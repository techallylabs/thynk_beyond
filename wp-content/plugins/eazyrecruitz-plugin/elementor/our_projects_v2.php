...
class Our_Projects_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_our_projects_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Projects V2', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_projects_v2',
			[
				'label' => esc_html__( 'Our Projects V2', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'query_number',
		...
		$this->add_control(
			'bottom_description',
			[
				'label'       => __( 'Bottom Description', 'eazyrecruitz' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter Section Bottom Description', 'eazyrecruitz' ),
			]
		);
                    ...
                    <div class="project-block-one">
                        <div class="inner-box">
                            <figure class="image-box">
                                ...
                                <?php the_post_thumbnail('eazyrecruitz_348x348'); ?>
                            </figure>
                            <div class="content-box">
                                ...
                                <div class="view-btn"><a href="<?php echo esc_url($post_thumbnail_url);?>" class="lightbox-image" data-fancybox="gallery">+</a></div>
                            </div>
                        </div>
                    </div>
                    <?php endwhile; ?>
                </div>
                <?php if($settings['bottom_description']) :?><div class="more-text centred"><p><?php echo wp_kses( $settings['bottom_description'], $allowed_tags );?></p></div><?php endif; ?>
            </div>
        </section>
