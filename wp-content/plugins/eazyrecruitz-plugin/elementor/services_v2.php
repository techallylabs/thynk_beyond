...
class Services_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_services_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Services V2', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'services_v2',
			[
				'label' => esc_html__( 'Services V2', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'bg_image',
	...
	protected function render() {
        ...
        <section class="service-section service-page">
            ...
            <div class="anim-icon">
                <div class="icon-1" style="background-image: url(<?php echo wp_get_attachment_url($settings['bg_image']['id']);?>);"></div>
