...
class Portfolio_V1 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_portfolio_v1';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio V1', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_v1',
			[
				'label' => esc_html__( 'Portfolio V1', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'number',
		...
		<?php 
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
                <div class="project-block-two">
                    <div class="inner-box">
                        <figure class="image-box"><?php the_post_thumbnail('eazyrecruitz_570x570'); ?></figure>
            ...
            <section class="portfolio-grid-1 protfolio-page">
