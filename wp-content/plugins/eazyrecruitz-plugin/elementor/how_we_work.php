...
class How_We_Work extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_how_we_work';
	}
	...
	public function get_title() {
		return esc_html__( 'How We Work', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'how_we_work',
			[
				'label' => esc_html__( 'How We Work', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'one',
				'options' => array(
					'one' => esc_html__( 'Choose Light Gray Color', 'eazyrecruitz' ),
					'two'  => esc_html__( 'Choose Dark Color', 'eazyrecruitz' ),
				),
			]
		);
	...
	protected function render() {
        ...
        <!-- process-style-two -->
        <section class="process-style-two <?php if($settings['style_two'] == 'two') echo 'alternet-2'; else echo ''; ?>">
            <div class="auto-container">
                <div class="inner-container">
                	<?php if($settings['style_two'] == 'two') :?><div class="pattern-layer" style="background-image: url(<?php echo esc_url(wp_get_attachment_url($settings['bg_image']['id']));?>);"></div><?php endif; ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 single-column">
                            <div class="single-item">
                                <div class="inner-box">
                                    <span><?php esc_html_e('Step', 'eazyrecruitz'); ?></span>
                                    <h2><?php $count = sprintf('%02d', $count); echo $count; ?>...</h2>
                                    ...
                                    <div class="link"><a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true ));?>"><i class="flaticon-right-arrow"></i><?php esc_html_e('More Details', 'eazyrecruitz'); ?></a></div>
                                </div>
                            </div>
                        </div>
                        <?php $count++; endwhile; ?>
