 ...
 * @since 1.0.0
 */
class Hiring_Strategies extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_hiring_strategies';
	}
	...
	public function get_title() {
		return esc_html__( 'Hiring Strategies', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'hiring_strategies',
			[
				'label' => esc_html__( 'Hiring Strategies', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
            'subtitle',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Hire Now', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'btn_link',
            ...
            <div class="auto-container">
                ...
                <div class="inner-box">
                    <div class="title-inner bg-color-2">
                        ...
                        <h2><?php echo wp_kses($settings['title1'], $allowed_tags) ;?></h2>
                        <a href="<?php echo esc_url($settings['btn_link']['url']) ;?>" class="theme-btn-two"><?php echo wp_kses($settings['btn_title'], $allowed_tags) ;?></a>
                    </div>
