 ...
 * @since 1.0.0
 */
class Portfolio_V5 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_portfolio_v5';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio V5', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'portfolio_v5',
			[
				'label' => esc_html__( 'Portfolio V5', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <div class="masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
            ...
            <section class="portfolio-wide-2 protfolio-page">
