 ...
 * @since 1.0.0
 */
class Dream_Job extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Dream Job', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'dream_job',
			[
				'label' => esc_html__( 'Dream Job', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
            'subtitle',
	...
	protected function render() {
        ...
        <section class="placejob-section applynow-section">
            <div class="auto-container">
                ...
                <?php echo do_shortcode($settings['contact_form_url6']) ;?>
