...
class Contact_Us extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_contact_us';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact Us', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'contact_us',
			[
				'label' => esc_html__( 'Contact Us', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
            'subtitle',
		...
		$this->add_control(
            'form_title',
            [
                'label'       => __('Form Title', 'eazyrecruitz'),
                'type'        => Controls_Manager::TEXTAREA,
                'dynamic'     => [
                    'active' => true,
                ],
                'placeholder' => __('Enter your Form Title', 'eazyrecruitz'),
            ]
        );
		$this->add_control(
            'contact_form_url3',
