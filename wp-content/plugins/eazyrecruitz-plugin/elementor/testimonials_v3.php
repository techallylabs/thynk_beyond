...
class Testimonials_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'eazyrecruitz_testimonials_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonials V3', 'eazyrecruitz' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v3',
			[
				'label' => esc_html__( 'Testimonials V3', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'bg_image',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Testimonials', 'eazyrecruitz' ),
			]
		);
		$this->add_control(
			'title',
            ...
            <div class="auto-container">
                ...
                <div class="three-item-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                    ...
                    <div class="testimonial-block-three">
                        <div class="inner-box">
                            <div class="border-shap" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/border-2.png);"></div>
                            <figure class="quote-box"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/quote-3.png" alt=""></figure>
