...
get_header();
global $wp_query;
$data  = \EAZYRECRUITZ\Includes\Classes\Common::instance()->data( 'search' )->get();
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?>">
                	<div class="blog-list-content">
                        ...
                        <div class="search-notfound">
                            <h4>
                                <?php printf(esc_html__( 'No result found for "%s"', 'eazyrecruitz' ), get_search_query()); ?>
                            </h4>
                            <p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'eazyrecruitz' ); ?></p>
                            <div class="sidebar">
