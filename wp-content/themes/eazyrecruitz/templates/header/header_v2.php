...
?>
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header style-two">
            <?php if( $options->get('header_topbar_v2') ):?>
                ...
                <div class="top-inner">
                    <ul class="left-info">
                        ...
                        <li>
                            ...
                            <p><span><?php esc_html_e('call:', 'eazyrecruitz'); ?> </span><a href="tel:<?php echo esc_url($options->get('phone_no_v2'));?>"><?php echo wp_kses($options->get('phone_no_v2'), $allowed_html);?></a></p>
                        </li>
                        <?php endif; ?>
                        <?php if( $options->get('email_address_v2') ):?>
                        <li>
                            <i class="flaticon-email"></i>
                            <p><span><?php esc_html_e('Mail:', 'eazyrecruitz'); ?> </span><a href="mailto:<?php echo esc_url($options->get('email_address_v2'));?>"><?php echo wp_kses($options->get('email_address_v2'), $allowed_html);?></a></p>
                        </li>
                        <?php endif; ?>
                    </ul>
                    <?php if( $options->get('location_info_v2') ):?>
                    <div class="location-box">
                        <div class="location-carousel owl-carousel owl-theme owl-dots-none">
                            <?php echo wp_kses($options->get('location_info_v2'), $allowed_html);?>
                        </div>
                        <?php endif; ?>
                        <?php if( $options->get('btn_title_v2') ):?>
                        <div class="apply-btn"><a href="<?php echo esc_url($options->get('btn_link_v2'));?>"><?php echo wp_kses($options->get('btn_title_v2'), $allowed_html);?><i class="flaticon-arrow-pointing-to-right"></i></a></div>
                    	<?php endif; ?>
                    </div>
                    
                    <div class="right-info">
                        <?php if( $options->get('menu_list_v2') ):?>
                        <ul class="list">
                            <?php echo wp_kses($options->get('menu_list_v2'), $allowed_html);?>
                        </ul>
                        <?php endif; ?>
                        <?php
            ...
            <div class="header-lower">
                <div class="outer-box clearfix">
                    ...
                    <ul class="menu-right-content pull-right clearfix">
                        ...
                        <?php endif; ?>
                        <?php if( $options->get('appointment_btn_title_v2') ):?>
                        <li>
                            <a href="<?php echo esc_url($options->get('appointment_btn_link_v2'));?>" class="theme-btn-one"><?php echo wp_kses($options->get('appointment_btn_title_v2'), $allowed_html);?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    <?php if( $options->get('heading_title_v2') ):?><h4><?php echo wp_kses($options->get('heading_title_v2'), $allowed_html);?></h4><?php endif; ?>
                    <ul>
                        <?php if( $options->get('address_v2') ):?><li><?php echo wp_kses($options->get('address_v2'), $allowed_html);?></li><?php endif; ?>
                        <?php if( $options->get('phone_no_v2') ):?><li><a href="tel:<?php echo esc_url($options->get('phone_no_v2'));?>"><?php echo wp_kses($options->get('phone_no_v2'), $allowed_html);?></a></li><?php endif; ?>
                        <?php if( $options->get('email_address_v2') ):?><li><a href="mailto:<?php echo esc_url($options->get('email_address_v2'));?>"><?php echo wp_kses($options->get('email_address_v2'), $allowed_html);?></a></li><?php endif; ?>
                    </ul>
                </div>
                <?php
					$icons = $options->get( 'header_v2_social_share' );
