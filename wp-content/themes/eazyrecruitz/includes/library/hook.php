 ...
 */
function eazyrecruitz_load_default_hooks() {

	$config = eazyrecruitz_WSH()->config( 'default' );
...
function eazyrecruitz_preloader() {
...
/**
 * [eazyrecruitz_main_header_area description]
 *
 * @return [type] [description]
 */


function eazyrecruitz_main_header_area() {
...
// echo $header_e;exit;
	...
	if ( $header == 'header_v1' ) {
		eazyrecruitz_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		eazyrecruitz_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		eazyrecruitz_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		eazyrecruitz_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		eazyrecruitz_template_load( 'templates/header/header_v5.php' );
	} else {
		eazyrecruitz_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [eazyrecruitz_main_footer_area description]
 *
 * @return [type] [description]
 */

function eazyrecruitz_main_footer_area() {
...
// echo $footer_e;exit;
	...
	if ( $footer == 'footer_v1' ) {
		...
		eazyrecruitz_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		eazyrecruitz_template_load( 'templates/footer/footer_v3.php' );
	} elseif ( $footer == 'footer_v4' ) {
		eazyrecruitz_template_load( 'templates/footer/footer_v4.php' );
	} else {
		eazyrecruitz_template_load( 'templates/footer/footer_set.php' );
	}
}
...
/**
 * [eazyrecruitz_sidebar description]
 *
 * @return [type] [description]
 */

function eazyrecruitz_sidebar( $data ) {

	eazyrecruitz_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [eazyrecruitz_banner description]
 *
 * @return [type] [description]
 */

function eazyrecruitz_banner( $data ) {

	eazyrecruitz_template_load( 'templates/banner/banner.php', compact( 'data' ) );
